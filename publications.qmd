...
<div class="pub-entry">
<p><strong>Contrast-Free ICA and Causal Inference via Wasserstein Distances to the Gaussian</strong></p>
<p class="pub-authors">Félix Laplante, Christophe Ambroise, Pierre Humbert</p>
<p class="pub-venue"><em>arXiv preprint</em>, July 2026</p>
<div class="pub-btns">
  <button class="btn btn-sm btn-outline-primary" onclick="togglePub(this, 'abs-4')">Abs</button>
  <a class="btn btn-sm btn-outline-danger" href="https://arxiv.org/abs/2607.12832" target="_blank">arXiv</a>
  <button class="btn btn-sm btn-outline-success" onclick="window.open('https://github.com/felixlaplante0/otica', '_blank', 'noopener'); window.open('https://github.com/felixlaplante0/otlingam', '_blank', 'noopener');" aria-label="Open OT-ICA and OT-LiNGAM repositories">Code</button>
  <button class="btn btn-sm btn-outline-secondary" onclick="togglePub(this, 'bib-4')">Bib</button>
  <a class="btn btn-sm btn-outline-dark" href="https://arxiv.org/pdf/2607.12832" target="_blank">PDF</a>
</div>
<div id="abs-4" class="pub-expand" hidden>
...
<div id="bib-4" class="pub-expand" hidden>
<pre>@misc{laplante2026contrast,
...
<p class="pub-authors">Félix Laplante, Christophe Ambroise</p>
<p class="pub-venue"><em>Computo</em> journal paper, December 2024</p>
<div class="pub-btns">
